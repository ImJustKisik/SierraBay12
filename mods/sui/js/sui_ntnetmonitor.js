;(function () {
	...
	function NTNetMonitor() {
		...
		return h("div", { style: { position: "relative" } },
			...
			h(SUI.Modal, {
				open: !!data.confirm_wireless_shutdown,
				title: "NTNet shutdown",
				onClose: function () { act("cancelToggleWireless") },
				width: "420px"
			},
				h("div", {
					style: {
				...
				h(SUI.Stack, { gap: "8px", justify: "flex-end", style: { width: "100%" } },
					h(SUI.Button, {
						onClick: function () { act("confirmToggleWireless") },
						style: { minWidth: "96px" }
					}, "Yes"),
					h(SUI.Button, {
						onClick: function () { act("cancelToggleWireless") },
						style: { minWidth: "96px" }
					}, "No")
				)
			)
